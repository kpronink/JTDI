...
urlpatterns = [
                  ...
                  url(r'^ajax/hide_vis_kanban_column/(?P<pk>[0-9]+)/$', views.hide_vis_kanban_column, name='hide_vis_kanban_column'),
                  ...
                  url(r'^del_user/(?P<pk>[0-9]+)/$', views.delete_user_in_project, name='del_user'),
