...
urlpatterns = [
                  ...
                  url(r'^ajax/kanban/$', views.get_kanban, name='kanban'),
                  url(r'^ajax/add_kanban_column/$', views.add_kanban_column, name='add_kanban_column'),
                  url(r'^ajax/add_kanban_task/$', views.add_kanban_task, name='add_kanban_task'),
